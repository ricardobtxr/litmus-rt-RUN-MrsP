...
/* This function is called after the schedule and after the call to finish_switch,
 * to allow to execute things like a spinning, for example.
 */
typedef void (*schedule_tail_t)(struct task_struct *prev);
