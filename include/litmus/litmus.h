...
#define tsk_rt_parms(t)		(&(t)->rt_param.task_params)
...
/*#define get_slice_budget(t)	(tsk_rt(t)->task_params.slice_budget)*/
...
/*#define get_slice_exec_time(t) 	(tsk_rt(t)->job_params.slice_exec_time)*/
