...
asmlinkage long sys_run_add_node(int __user *id, lt_t __user *rate_a, lt_t __user *rate_b, int __user *level);
	...
	case LRT_run_add_node:
		...
		case LRT_od_open:
			...
			return sys_run_add_node(
                                syscall_args.run_node.id,
                                syscall_args.run_node.rate_a,
                                syscall_args.run_node.rate_b,
                                syscall_args.run_node.level);
		}
